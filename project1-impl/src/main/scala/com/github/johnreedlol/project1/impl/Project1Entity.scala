...
/**
  * This is an event sourced entity. It has a state, [[Project1State]], which
  ...
  */
class Project1Entity extends PersistentEntity {

  override type Command = Project1Command[_]
  override type Event = Project1Event
  override type State = Project1State

  /**
    * The initial state. This is used if there is no snapshotted state to be found.
    */
  override def initialState: Project1State = Project1State("Hello", LocalDateTime.now.toString)
  ...
  override def behavior: Behavior = {
    case Project1State(message, _) => Actions().onCommand[UseGreetingMessage, Done] {
      ...
      case (GreetingMessageChanged(newMessage), state) =>
        ...
        // the event.
        Project1State(newMessage, LocalDateTime.now().toString)
...
/**
  ...
  */
case class Project1State(message: String, timestamp: String)

object Project1State {
  /**
    ...
    */
  implicit val format: Format[Project1State] = Json.format
}

/**
  * This interface defines all the events that the Project1Entity supports.
  */
sealed trait Project1Event extends AggregateEvent[Project1Event] {
  def aggregateTag: AggregateEventTag[Project1Event] = Project1Event.Tag
}

object Project1Event {
  val Tag: AggregateEventTag[Project1Event] = AggregateEventTag[Project1Event]
}

/**
  * An event that represents a change in greeting message.
  */
case class GreetingMessageChanged(message: String) extends Project1Event
...
/**
  ...
  */
sealed trait Project1Command[R] extends ReplyType[R]
...
/**
  ...
  */
case class UseGreetingMessage(message: String) extends Project1Command[Done]
...
/**
  ...
  * person.
  */
case class Hello(name: String) extends Project1Command[String]
...
/**
  ...
  * application loader.
  */
object Project1SerializerRegistry extends JsonSerializerRegistry {
  override def serializers: Seq[JsonSerializer[_]] = Seq(
    JsonSerializer[UseGreetingMessage],
    JsonSerializer[Hello],
    JsonSerializer[GreetingMessageChanged],
    JsonSerializer[Project1State]
  )
}
